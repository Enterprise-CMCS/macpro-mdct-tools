...
| `STACKPORT_SERVICES`         | _(35 services)_         | Comma-separated list to probe                            |
...
- `ui/dist/` is gitignored — `scripts/build-stackport-ui.sh` (via `run-stackport.sh` / `mdct-setup.sh`) builds it locally
